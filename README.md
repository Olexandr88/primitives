...
Design token data is stored in the [src/tokens](./src/tokens/) directory. These tokens are compiled with [style dictionary](https://github.com/style-dictionary/style-dictionary) in [scripts/buildTokens.ts](./scripts/buildTokens.ts).
